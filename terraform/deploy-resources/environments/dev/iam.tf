...
#   # Resource Tags
#   env          = "dev" #update to environment variable later.
...
#   log_bucket_arn        = module.s3_log_buckets.operations_bucket_arn
#   operations_bucket_arn = module.s3_log_buckets.log_bucket_arn
