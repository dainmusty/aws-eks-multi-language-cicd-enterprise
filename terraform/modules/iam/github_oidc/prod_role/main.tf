...
# Prod role: More restrictive, only allow main branch
  ...
  assume_role_policy = jsonencode({
    ...
    Statement = [{
      ...
      Condition = {
        ...
        StringLike = {
          # Allow only the main branch to deploy to prod
          "token.actions.githubusercontent.com:sub" = "repo:yourcompany/infrastructure:main"
        }
      }
    }]
  })
